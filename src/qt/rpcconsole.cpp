                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNXBPathCustom = GetArg("-zNXBbackuppath", "");
    ...
    if(!strzNXBPathCustom.empty()) {
        ui->wallet_customzNXBbackuppath->setText(QString::fromStdString(strzNXBPathCustom));
        ui->wallet_customzNXBbackuppath_label->setVisible(true);
        ui->wallet_customzNXBbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNXBPathCustom.empty()) && nCustomBackupThreshold > 0) {
