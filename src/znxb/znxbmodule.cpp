...
bool ZNXBModule::createInput(CTxIn &in, CZerocoinMint mint, uint256 hashTxOut){
...
PublicCoinSpend ZNXBModule::parseCoinSpend(const CTxIn &in, const CTransaction& tx){
...
bool ZNXBModule::validateInput(const CTxIn &in, const CTxOut &prevOut, const CTransaction& tx, PublicCoinSpend& ret){
