...
#define MASTERNODE_EXPIRATION_SECONDS (20 * 60)
#define MASTERNODE_REMOVAL_SECONDS (21 * 60)
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 1000000 NXB, signature to prove
