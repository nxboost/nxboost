...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that znxbspends need to use the cs_spendcache
...
public:
    ...
    string GetUniqueWalletBackupName(bool fznxbAuto) const;
    ...
    */
    ...
    /** zNXB reset */
    boost::signals2::signal<void()> NotifyzNXBReset;
