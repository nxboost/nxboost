...
class BIP65Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test that blocks must now be at least version 7")
        tip = self.nodes[0].getbestblockhash()
        block_time = self.nodes[0].getblockheader(tip)['mediantime'] + 1
        ...
        self.log.info("Test that a version 7 block with a valid-according-to-CLTV transaction is accepted")
