...
from fake_stake.base_test import NXBoost_FakeStakeTest

class zNXBValidCoinSpendTest(NXBoost_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zNXBs..." % DENOM_TO_USE)
