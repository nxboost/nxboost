...
#   c) node1 mines 32 blocks, so now node 0 has 60001NXB, node 1 has 4250NXB, node2 has none.
#   d) node0 sends 601 NXB to node2, in two transactions (301 NXB, then 300 NXB).
