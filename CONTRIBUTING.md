Contributing to NXBoost Core
============================

The NXBoost Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nxboost/nxboost/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NXBoost Core project, and is not to be
confused with overall NXBoost Network Protocol consensus changes.

Whether a pull request is merged into NXBoost Core rests with the project merge
...
Patches that change NXBoost consensus rules are considerably more involved than
...
Where a patchset proposes to change the NXBoost consensus, it must have been
...
The project leader is the release manager for each NXBoost Core release.
