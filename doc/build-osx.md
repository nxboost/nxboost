...
1. Clone the NXBoost Core source code:
...
NXBoost Core is now available at `./src/nxboostd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/NXBoost"

    touch "/Users/${USER}/Library/Application Support/NXBoost/nxboost.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/NXBoost/nxboost.conf"

The first time you run nxboostd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/nxboostd -daemon # Starts the nxboost daemon.
    ./src/nxboost-cli --help # Outputs a list of command-line options.
    ./src/nxboost-cli help # Outputs a list of RPC commands when the daemon is running.
