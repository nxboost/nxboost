...
In order to support loading of multiple wallets in nxboost-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nxboost.cpp.
...
Changes to nxboost.cpp
----------------------
nxboost.cpp is the entry point into nxboost-qt, and as such, will require some minor modifications to provide hooks for
